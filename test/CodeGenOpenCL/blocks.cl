...
// COMMON: @__block_literal_global = internal addrspace(1) constant { i8 addrspace(4)* } { i8 addrspace(4)* addrspacecast (i8* bitcast (void (i8 addrspace(4)*, i8 addrspace(3)*)* @block_A_block_invoke to i8*) to i8 addrspace(4)*) }
// COMMON-NOT: .str
...
void foo(){
  ...
  // COMMON: %[[block_invoke:.*]] = getelementptr inbounds <{ i8 addrspace(4)*, i32 }>, <{ i8 addrspace(4)*, i32 }>* %[[block:.*]], i32 0, i32 0
  ...
  // COMMON: %[[block_captured:.*]] = getelementptr inbounds <{ i8 addrspace(4)*, i32 }>, <{ i8 addrspace(4)*, i32 }>* %[[block]], i32 0, i32 1
  // COMMON: %[[r0:.*]] = load i32, i32* %i
  // COMMON: store i32 %[[r0]], i32* %[[block_captured]],
  // COMMON: %[[r1:.*]] = bitcast <{ i8 addrspace(4)*, i32 }>* %[[block]] to i32 ()*
...
// COMMON:  %[[block:.*]] = bitcast i8 addrspace(4)* %.block_descriptor to <{ i8 addrspace(4)*, i32 }> addrspace(4)*
// COMMON:  %[[block_capture_addr:.*]] = getelementptr inbounds <{ i8 addrspace(4)*, i32 }>, <{ i8 addrspace(4)*, i32 }> addrspace(4)* %[[block]], i32 0, i32 1

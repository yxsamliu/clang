...
// NOOPT: @test_static_var.sp1 = internal addrspace(1) global i8 addrspace(5)* null), align 4
// NOOPT: @test_static_var.sp2 = internal addrspace(1) global i8 addrspace(5)* null), align 4
// NOOPT: @test_static_var.sp3 = internal addrspace(1) global i8 addrspace(5)* null), align 4
...
// NOOPT: @test_static_var.SS1 = internal addrspace(1) global %struct.StructTy1 { i8 addrspace(5)* null), i8 addrspace(3)* addrspacecast (i8* null to i8 addrspace(3)*), i8 addrspace(4)* null, i8 addrspace(1)* null, i8* null }, align 8
...
// CHECK: store i8 addrspace(5)* null, i8 addrspace(5)** {{.*}}
...
// NOOPT: %{{.*}} = sub i64 %{{.*}}, 0
// NOOPT: call void @test_fold_callee
// NOOPT: %{{.*}} = add nsw i64 %{{.*}}, sext (i32 ptrtoint (i32 addrspace(5)* null to i32) to i64)
// NOOPT: %{{.*}} = sub nsw i64 %{{.*}}, 1

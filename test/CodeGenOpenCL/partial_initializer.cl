...
// CHECK: @GA = addrspace(1) global [6 x [6 x float]] [[6 x float] [float 1.000000e+00, float 2.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00], [6 x float] zeroinitializer, [6 x float] zeroinitializer, [6 x float] zeroinitializer, [6 x float] zeroinitializer, [6 x float] zeroinitializer], align 4
...
// CHECK-LABEL: define spir_func void @f() #0 {

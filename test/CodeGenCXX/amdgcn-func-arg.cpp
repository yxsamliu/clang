...
// CHECK-LABEL: define void @_Z22func_with_indirect_arg1A(%class.A* %a)
// CHECK:  %p = alloca %class.A*, align 8, addrspace(5)
// CHECK:  %[[r0:.+]] = addrspacecast %class.A* addrspace(5)* %p to %class.A**
// CHECK:  store %class.A* %a, %class.A** %[[r0]], align 8
...
// CHECK:  call void @_Z22func_with_indirect_arg1A(%class.A* %[[r1]])
...
// CHECK:  call void @llvm.memcpy.p0i8.p0i8.i64
// CHECK:  call void @_Z22func_with_indirect_arg1A(%class.A* %[[r0]])
// CHECK:  call void @_ZN1AD1Ev(%class.A* %[[r0]])
